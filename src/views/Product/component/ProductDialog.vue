      ...
      >
        <div :style="'width: calc(100% - ' + dialogProps.labelWidth! / 2 + 'px)'">
          ...
          <el-form-item label="商品价格" prop="price">
            <el-input v-model="dialogProps.row!.price" placeholder="请填写商品价格" clearable maxlength="10" show-word-limit></el-input>
          </el-form-item>

          <el-form-item label="商品库存" prop="stock">
            <el-input v-model="dialogProps.row!.stock" placeholder="库存" clearable maxlength="100" show-word-limit></el-input>
          </el-form-item>
        </div>
...
const rules = reactive({
  name: [{ required: true, message: '请输入商品价格', trigger: 'blur' }],
  price: [
    { required: true, message: '请输入商品价格', trigger: 'blur' },
    {
      pattern: /^\d+(\.\d{1,2})?$/,
      message: '商品价格最多到小数点后两位',
      trigger: 'blur'
    }
  ],
  stock: [
